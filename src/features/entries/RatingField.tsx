...
/**
 * Star rating with an inline scale switch (1–5 / 1–10). The stars are
 * self-explanatory, so this carries no field label. Switching the scale writes
 * the global setting, so it stays in sync with Profile and across every entry.
 */
